...
TEST_CASE("convex_polygon valid triangle CCW", "[polygon][construction]") {
    kdtree::convex_polygon<double> poly = {
        dpoint(0.0, 0.0), dpoint(2.0, 0.0), dpoint(1.0, 2.0)
    };
    REQUIRE(poly.size() == 3);
}
...
TEST_CASE("convex_polygon valid triangle CW normalizes to CCW", "[polygon][construction]") {
    kdtree::convex_polygon<double> poly = {
        dpoint(0.0, 0.0), dpoint(1.0, 2.0), dpoint(2.0, 0.0)
    };
    REQUIRE(poly.size() == 3);
}
...
TEST_CASE("convex_polygon valid quadrilateral", "[polygon][construction]") {
    kdtree::convex_polygon<double> poly = {
        dpoint(0.0, 0.0), dpoint(2.0, 0.0), dpoint(2.0, 2.0), dpoint(0.0, 2.0)
    };
    REQUIRE(poly.size() == 4);
}
...
TEST_CASE("convex_polygon rejects collinear points", "[polygon][construction]") {
    ...
    REQUIRE_THROWS_AS(
        kdtree::convex_polygon<double>(pts.begin(), pts.end()),
        std::runtime_error
    );
}
...
TEST_CASE("convex_polygon rejects non-convex polygon", "[polygon][construction]") {
    ...
    std::vector<dpoint> pts = {
        dpoint(0.0, 0.0), dpoint(2.0, 2.0), dpoint(2.0, 0.0), dpoint(0.0, 2.0)
    };
    REQUIRE_THROWS_AS(
        kdtree::convex_polygon<double>(pts.begin(), pts.end()),
        std::runtime_error
...
TEST_CASE("convex_polygon contains interior point", "[polygon][contains]") {
    kdtree::convex_polygon<double> poly = {
        dpoint(0.0, 0.0), dpoint(4.0, 0.0), dpoint(4.0, 4.0), dpoint(0.0, 4.0)
    };
...
TEST_CASE("convex_polygon triangle containment", "[polygon][contains]") {
    kdtree::convex_polygon<double> tri = {
        dpoint(0.0, 0.0), dpoint(2.0, 0.0), dpoint(1.0, 2.0)
    };
...
TEST_CASE("convex_polygon CW triangle has same containment as CCW", "[polygon][contains]") {
    kdtree::convex_polygon<double> ccw = {
        dpoint(0.0, 0.0), dpoint(4.0, 0.0), dpoint(2.0, 4.0)
    };
    kdtree::convex_polygon<double> cw = {
        dpoint(0.0, 0.0), dpoint(2.0, 4.0), dpoint(4.0, 0.0)
    };
